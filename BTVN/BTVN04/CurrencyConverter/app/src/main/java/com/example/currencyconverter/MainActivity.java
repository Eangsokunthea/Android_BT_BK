...
public class MainActivity extends AppCompatActivity {
    ...
    String[] country = {"AFN", "EUR", "ALL", "DZD", "USD", "AOA", "XCD", "ARS", "AMD", "AWG", "AUD", "AZN", "BSD", "BHD", "BDT", "BBD", "BYN", "BZD", "XOF", "BMD", "INR", "BNT", "VND", "KHR"}; //TODO
    ...
    public String getConversionRate(String convertFrom, String convertTo, Double amountToConvert){
        ...
        String url = "https://free.currconv.com/api/v7/convert?q="+convertFrom+"_"+convertTo+"&compact=ultra&apiKey=aa76070aae72b52b99b2";
